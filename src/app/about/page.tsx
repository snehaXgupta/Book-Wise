    ...
    <div className="max-w-3xl mx-auto px-6 py-12 text-[#7c4f2c] font-serif text-lg space-y-10 text-center">
      <section>
        ...
        <p className="leading-relaxed">
          ...
          <br /><br />
<<<<<<< HEAD
          One rainy afternoon, as mist curled around the windows, a stranger stepped in. He wasn not a knight, nor a prince, but a boy with stories in his eyes and hands that smelled of parchment and ink. His name was Darien. He did not promise castles or stars, only silence shared between sips of warm espresso and soft gasps at plot twists.
          <br /><br />
          Over cups of cinnamon coffee and pages worn soft by love, they discovered not just books but each other. In the warmth of that quiet space, Serenes heart learned that magic does not always roar. Sometimes, it just reads beside you.
=======
...
>>>>>>> 10077e648bd8f29cbb99854671d374c46e0193c9
        </p>
      </section>
