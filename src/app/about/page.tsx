    ...
    <div className="max-w-3xl mx-auto px-6 py-12 text-[#7c4f2c] font-serif text-lg space-y-10 text-center">
      <section>
        ...
        <p className="leading-relaxed">
          Once in the quiet village of Thistlebrook, where clouds danced lazily and time moved like honey, there lived a soft spoken girl named Serene. Her world was made of poems and pages, tucked between the shelves of a little coffeehouse library she called home. Serene never chased grand adventures; she whispered to them in the margins of books, hoping they’d hear.
          <br /><br />
          One rainy afternoon, as mist curled around the windows, a stranger stepped in. He wasn’t a knight, nor a prince, but a boy with stories in his eyes and hands that smelled of parchment and ink. His name was Darien. He didn’t promise castles or stars, only silence shared between sips of warm espresso and soft gasps at plot twists.
          <br /><br />
      ...
      <section className="mt-12 border-t border-[#bfa58c] pt-8 text-center">
        ...
        <p className="leading-relaxed max-w-2xl mx-auto text-[#7c4f2c]">
          ...
          Whether you're looking to escape into fantasy, sink into soft romance, or learn from non fiction, BookWise guides
          you gently. With mood based prompts, category filtering, and aesthetic design, it’s like asking your favorite
